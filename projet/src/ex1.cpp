...
struct Application {
    ...
    void InitializeObject(My3DObject& object, uint32_t& VAO, uint32_t& VBO) {
        ...
        GLuint program = object.getProgram().GetProgram();
    ...
    void RenderObject(const My3DObject& object, uint32_t VAO) {
        uint32_t program = object.getProgram().GetProgram();
    ...
    void Render() {
        ...
        RenderObject(object1, m_VAO1);
        RenderObject(object2, m_VAO2);
    }
};
